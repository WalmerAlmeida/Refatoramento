...
import com.company.sistema.SistemaMenuCarrinho;
...
public class MenuCarrinho {
    ...
    public void MenuCarrinho(Carrinho carrinhoAtual, int idContaLogin){
        ...
        SistemaMenuCarrinho novoSistemaMenuCarrinho = new SistemaMenuCarrinho();
        ...
        switch (opcao) {
            case 1://Mudar a Quantidade de Algum Item
                novoSistemaMenuCarrinho.aumentarQuantidade(carrinhoAtual);
                break;
            case 2://Finalizar Compra//lembrar de remover todos os itens do carrinho e inserir os itens nos produtos pagos
                novoSistemaMenuCarrinho.finalizarCompra(carrinhoAtual, idContaLogin, DadosLojaseContas.Contas);
                break;
            case 0://sair
