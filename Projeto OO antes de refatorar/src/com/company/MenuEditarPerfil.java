        ...
        while (true) {
            ...
            switch (opcao) {
                ...
                case 2://Nome da Conta
                    ...
                    contaAtual.setNomeDaConta(nomeDaConta);
                    lojaAtual.setNomeDaConta(nomeDaConta);
                    break;
                case 3://CPF
                    ...
                    contaAtual.setCPF(CPF);
                    lojaAtual.setCPF(CPF);
                    break;
                case 4://Endereço
                    System.out.println("Digite o endereço");
                    endereco = input.next();
                    contaAtual.setEndereco(endereco);
                    lojaAtual.setEndereco(endereco);
                    break;
                case 5://Senha
