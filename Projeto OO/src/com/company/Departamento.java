...
public class Departamento {
    ...
    public void adicionarProduto(String nomeDoProduto, String descricao, String nomeDoDepartamento, double preco, double altura, double comprimento, double largura, double peso, int tipo){
        ...
        novoProduto.adicionarProduto(nomeDoProduto, descricao, nomeDoDepartamento, preco, altura, comprimento, largura, peso);
