...
public class ProdutoConsumíveis extends Produto{
    ...
    public void adicionarProduto(String nomeDoProduto, String descricao, String departamento, double preco, double altura, double comprimento, double largura, double peso) {
        ...
        super.adicionarProduto(nomeDoProduto, descricao, departamento, preco, altura, comprimento, largura, peso);
    ...
    public void editarProduto(String nomeDoProduto, String descricao, double preco, double altura, double comprimento, double largura, double peso){
        boolean continua;
        int dia, mês, ano, data = 0;
        super.editarProduto(nomeDoProduto, descricao, preco, altura, comprimento, largura, peso);
        System.out.println("Digite a data de vencimento");
        do {
            try {
                this.dataDeVencimento = input.next();
